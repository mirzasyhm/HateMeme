...
class HatefulMemesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        clip_inputs = self.clip_processor(text=text, images=image, return_tensors="pt", padding=True, truncation=True)
        ...
        input_ids = roberta_encoding['input_ids'].squeeze()        # Shape: (max_length,)
        attention_mask = roberta_encoding['attention_mask'].squeeze()  # Shape: (max_length,)
